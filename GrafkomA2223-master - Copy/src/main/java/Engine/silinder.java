...
public class silinder extends Circle{
    ...
    int stackCount;
    int sectorCount;
    public silinder(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
